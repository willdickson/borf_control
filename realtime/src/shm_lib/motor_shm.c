/*-------------------------------------------------------------------
  ...
  simple_step is free software: you can redistribute it and/or modify
...
--------------------------------------------------------------------
  ...
  Purpose: shared memory library for communication with motor_ctl
  realtime stepper/pwm motor driver.
...
// Fucntions for accessing command IDs and other constants from 
